...
- 14 files · ~170,277 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary

- 48 nodes · 63 edges · 7 communities detected
...
- **Thin community `Community 5`** (2 nodes): `convert.lua`, `M.html_to_markdown()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 6`** (1 nodes): `run.lua`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
